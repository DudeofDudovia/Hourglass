...
public class ValueSliderAddedTimesFadeOut : MonoBehaviour
{
    public Slider Slider;
    public void SaveSlider()
    {
        PlayerPrefs.SetFloat(TCS.Profile + "ValueAddedTimesFadeOut", Slider.value);
        PlayerPrefs.Save();
    }
    public void Awake()
    {
    ...
    {
        if (PlayerPrefs.HasKey(TCS.Profile + "ValueAddedTimesFadeOut"))
        {
            Slider.value = PlayerPrefs.GetFloat(TCS.Profile + "ValueAddedTimesFadeOut");
        }
        else { Slider.value = 1; }
    }
    ...
    {
        Adjusted = false;
        TCS.AddedTimesFadeOutVal = Slider.value;
    }
    public void Update()
    {
