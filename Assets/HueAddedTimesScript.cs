...
public class HueAddedTimesScript : MonoBehaviour
{
    ...
    {
        PlayerPrefs.SetFloat(TCS.Profile + "HueAddedTimes", Slider.value);
        PlayerPrefs.Save();
    }
    public void Awake()
    {
    ...
    {
        if (PlayerPrefs.HasKey(TCS.Profile + "HueAddedTimes"))
        {
            Slider.value = PlayerPrefs.GetFloat(TCS.Profile + "HueAddedTimes");
        }
    ...
    public void Start()
    {
        LoadProfile();
                Adjusted = false;
        TCS.AddedTimesHue = Slider.value;
    }
    public void Update()
    {
        TCS.AddedTimesHue = Slider.value;
