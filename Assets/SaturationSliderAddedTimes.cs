...
public class SaturationSliderAddedTimes : MonoBehaviour
{
    public Slider Slider;
    public void SaveSlider()
    {
        PlayerPrefs.SetFloat(TCS.Profile + "SaturationAddedTimes", Slider.value);
        PlayerPrefs.Save();
    }
    public void Awake()
    {
    ...
    {
        if (PlayerPrefs.HasKey(TCS.Profile + "SaturationAddedTimes"))
        {
            Slider.value = PlayerPrefs.GetFloat(TCS.Profile + "SaturationAddedTimes");
        }
        else { Slider.value = 0; }
    }
    ...
    public void Start()
    {
        LoadProfile();
                ...
                Adjusted = false;
        TCS.AddedTimesSat = Slider.value;
    }
    public void Update()
    {
        TCS.AddedTimesSat = Slider.value;
